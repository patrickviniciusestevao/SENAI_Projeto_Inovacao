...
{
	partial class FormItensRequerimento
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Itens Requerimento";
			// 
			// FormItensRequerimento
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.ClientSize = new System.Drawing.Size(780, 419);
			this.Controls.Add(this.label1);
			this.Name = "FormItensRequerimento";
			this.Text = "Itens de Requerimento";
